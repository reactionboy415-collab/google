...
# --- 1. THE ULTIMATE STRICT SYSTEM PROMPT ---
SYSTEM_PROMPT = (
    "STRICT RULE: Output ONLY the lyrics. Start directly with '[Verse 1]'. "
    "No conversational filler, no copyright warnings, no introductions, no 'Here are your lyrics'. "
    "If you fail this, you will be disconnected. Minimum 300 words. "
    "Topic: "
)
...
async def handle_music_generation(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        # --- ✂️ STRICTOR CLEANING LOGIC ---
        # This regex looks for [Verse 1] and starts from there, cutting out everything before it.
        ...
        # Remove any potential "Would you like..." trailing questions
